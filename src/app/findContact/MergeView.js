...
**
** This file defines mergeView for the findContacts module
...
define(['dojo/_base/declare',
	...
	return declare([ModuleScrollableView], {	
		...
		activate: function(e){
			topic.publish("/dojo-mama/updateSubNav", {back: '/findContact', title: "Manage your contacts"} );
			...
			if(this.selectorBar){
				this.selectorBar.destroyRecursive();
				this.buildSelectorBar(this.currentUser);
			}else{
				this.buildSelectorBar(this.currentUser);
			}
