...
**
** This file defines the userAlpha module
** 
**
...
define(['dojo/_base/declare',
		...
		'app/util/xhrManager',
		'app/userAlpha/MainView',
		'app/userAlpha/FeedView'
], function(
	declare, 
	Module, 
	lang, 
	...
	return declare([Module], {
		...
		postCreate: function(){
			...
			this.rootView = new MainView({
				...
				getFriendContacts: lang.hitch(this, this.getFriendContacts),
		...
		getFriendContacts: function(from){
			var params = {from: from};
			return xhrManager.send('GET', 'rest/v1.0/Contacts/getFriendContacts', params)
		},
