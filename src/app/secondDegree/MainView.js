...
**
** This file defines the mainView of the secondDegree module
** 
**
...
define(['dojo/_base/declare',
	...
	return declare([ModuleScrollableView], {		
		...
		activate: function() {
			...
			topic.publish("/dojo-mama/updateSubNav", {back: '/people', title: "Friends of Friends"} );
			if(this.list){
		...
		getNextGroup: function(){
			this.getSecondFriendContacts(this.fromVar+=20).then(lang.hitch(this,this.postAddListItems));
		}
	})
});
