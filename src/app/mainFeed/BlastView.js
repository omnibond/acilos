...
define(['dojo/_base/declare',
	...
	return declare([ModuleScrollableView], {		
		...
		buildUploadBar: function(){
			...
			var postNowLabel = domConstruct.create("span", {innerHTML: "Blast now", "class": "radioButtonLabel"});
			var postLaterLabel = domConstruct.create("span", {innerHTML: "Blast Later", "class": "radioButtonLabel"});
		...
		activate: function(e){
			topic.publish("/dojo-mama/updateSubNav", {back: "/mainFeed", title: "Blast this post to your friends"} );
			
			console.log(this.blastObj);
