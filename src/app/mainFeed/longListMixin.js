...
**
** This file defines the longListMixin for feedScrollers
** This is DEPRECATED
**
...
define([ 
	...
	return declare("dojox.mobile.LongListMixin", null, {
		...
		startup : function(){
			...
			//setting global var for the feed y location
			kernel.global.feedPosition[this.feedName] = {};
			kernel.global.feedPosition[this.feedName].count = 20;
		...
		_loadItems : function(toPos){
			...
			//if(cury > (this.bottomLoc - 1500)){
			//	console.log("y", cury);
			//	console.log("yMin", this._loadedYMin);
			//	console.log("x", this.bottomLoc - 500);
			//	this.getNextGroup();
			//	kernel.global.feedPosition[this.feedName].count += 20;
			//}
		},
		...
		_addAfter: function(){
			...
			for(count = 0, i = this._lastIndex+1; count < this.pageSize && i < this._items.length; count++, i++){
				...
				this._lastIndex = i;
				this.bottomLoc = item.domNode.offsetTop;
				if(this.FeedName != ""){
					if(i > kernel.global.feedPosition[this.feedName].count - 10){
						this.getNextGroup();
						kernel.global.feedPosition[this.feedName].count += 20;
					}
				}
