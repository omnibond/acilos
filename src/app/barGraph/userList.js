...
**
** This file defines userList for the barGraph module
**
...
define(['dojo/_base/declare',
	...
	return declare([ModuleScrollableView], {		
		...
		activate: function() {
			topic.publish("/dojo-mama/updateSubNav", {back: '/barGraph', title: "Select Users"} );
			this.fromVar = 0;
				...
				onClick: lang.hitch(this, function(){
					...
					for(var g = 0; g < kids.length; g++){
						if(kids[g].checked == true){
							this.userGraph.users.push(kids[g].objID);
						}				
					}
