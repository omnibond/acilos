...
define(['dojo/_base/declare',
		...
		'app/downloadAndBackUpData/MainView'
], function(
	declare, 
	Module, 
	lang, 
	...
	return declare([Module], {
		...
		saveBackupData: function(wipeCurrentData, downloadData){
			var params = {wipeCurrentData: wipeCurrentData, downloadData: downloadData};
