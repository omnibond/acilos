define(["../main", "dojo/_base/lang", "dojo/_base/array","dojo/_base/declare", "dojo/dom-style",
	...
	var dc = lang.getObject("charting", true, dojox),
		...
		destroy = func.lambda("item.destroyRecursive()"),
	...
	var Chart = declare(has("dojo-bidi")? "dojox.charting.NonBidiChart" : "dojox.charting.Chart", null, {
		...
		addAxis: function(name, kwArgs){
			...
			if(name in this.axes){
				this.axes[name].destroyRecursive();
			}
			this.axes[name] = axis;
			this.dirty = true;
			return this;	//	dojox/charting/Chart
		...
		addPlot: function(name, kwArgs){
			...
			if(name in this.plots){
				this.stack[this.plots[name]].destroyRecursive();
		...
		removePlot: function(name){
			...
			if(name in this.plots){
				...
				// destroy the plot
				this.stack[index].destroyRecursive();
		...
		addSeries: function(name, data, kwArgs){
			...
			if(name in this.runs){
				this.series[this.runs[name]].destroyRecursive();
		...
		removeSeries: function(name){
			...
			if(name in this.runs){
				...
				// destroy the run
				this.series[index].destroyRecursive();
