#!/bin/sh
#this script is called by saveRebootSettings in Database.php to populate the shell file called by the cron to reboot #the computer each morning at 4:30 am to free up resources
